...
namespace MarTwFive.Controllers
{
    public class CamperController : Controller
    {
        private readonly MarTwFiveContext _context;

        public CamperController(MarTwFiveContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstNickName,Email,Birthdate,EnrollmentDate")] Camper camper)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ID,LastName,FirstNickName,Email,Birthdate,EnrollmentDate")] Camper camper)
        {
            if (id != camper.ID)
            {
                return NotFound();
